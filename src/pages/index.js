    ...
    <div id='about' className="relative bg-white">
      <div className="mx-auto  max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        ...
        <Image
              ...
              height="1024"
              width="1024"
              className="mt-10 aspect-[6/5] w-full max-w-lg rounded-2xl object-cover sm:w-full md:w-full md:mx:auto sm:mt-10 lg:mt-0 lg:max-w-none xl:row-span-2 xl:row-end-2 xl:mt-36"
            />
        </div>
      </div>
    </div>
