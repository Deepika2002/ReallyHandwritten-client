...
export default function WelcomeInput({ handleBack, handleNext, formValues, onChange }) {
      ...
      <div className="lg:pl-64 overflow-hidden bg-white">
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
                  <p className="mt-8 text-2xl leading-8 font-semibold text-gray-900">Let's design your first handwritten template.
</p>
                  <div className="mt-10">
                      <label className="text-base font-semibold text-gray-900">How would you like to address your client?</label>
            ...
            Next
              ...
              <div className="mx-auto flex max-w-2xl  lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
                  <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                      <div>
                          <Image
                              src="/assets/one_card.jpg"
                              alt="App screenshot"
                              width={400}
                              height={400}
                              className=" aspect-1 w-full max-w-lg rounded-2xl object-cover  lg:max-w-none xl:row-span-2 xl:row-end-2 "
                          />
                      </div>
                  </div>
              </div>
